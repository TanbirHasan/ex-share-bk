...
export async function buildApp(): Promise<FastifyInstance> {
  ...
  await app.register(pricesRoutes, { prefix: "/api/v1/products" });
  ...
  await app.register(auditRoutes, { prefix: "/api/v1/admin/audit-log" });
  await app.register(insightsRoutes, { prefix: "/api/v1/admin/search-insights" });
  await app.register(mergeRoutes, { prefix: "/api/v1/admin/problems" });
  await app.register(pendingRoutes, { prefix: "/api/v1/admin/pending" });
  await app.register(commentsRoutes, { prefix: "/api/v1" });
  await app.register(qaRoutes, { prefix: "/api/v1" });
  await app.register(followsRoutes, { prefix: "/api/v1" });
